...
for snr in snr_list:
    ...
    df1 = pd.read_csv("./RESULTS/COMBSSV2-Scaled-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
    ...
    df2 = pd.read_csv("./RESULTS/COMBSSV2-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
    ...
    df3 = pd.read_csv("./RESULTS/COMBSS-Normalised-Improved-case-%s-n-%d-p-%s-q-%s-corr-%s-ninit-%s-snr-%s-ndatasets-%s-nlam-%s-eta-%s.csv" %(beta_type, n, p, q, corr, n_tinit, snr,  n_datasets, nlam, eta))
...
combssV1, = plt.plot(snr_list, mseV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, mseV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, mseV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')


plt.xlabel('Signal to Noise Ratio')
plt.ylabel('MSE')
plt.title(f'COMBSS Variants Mean Squared Error, Beta Case {beta_type}, {dimension} Dimension')
plt.legend(handles = [combssO, combssV1, combssV2, combssNI])
...
combssV1, = plt.plot(snr_list, peV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, peV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, peV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
...
combssV1, = plt.plot(snr_list, mccV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, mccV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, mccV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
...
combssV1, = plt.plot(snr_list, accuracyV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, accuracyV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, accuracyV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
...
combssV1, = plt.plot(snr_list, f1V1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, f1V2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, f1V3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
...
combssV1, = plt.plot(snr_list, sensitivityV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, sensitivityV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, sensitivityV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
...
combssV1, = plt.plot(snr_list, specificityV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, specificityV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, specificityV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
...
combssV1, = plt.plot(snr_list, timeV1, label = "COMBSS-Mod FGD", color = "red", marker='^')
combssV2, = plt.plot(snr_list, timeV2, label = "COMBSS-Mod BCD", color = "green", marker='s')
combssNI, = plt.plot(snr_list, timeV3, label = "COMBSS Improved", color = "dodgerblue", marker='H')
