...
MCC_HD
ggsave("MCC-HD-Case-2.png", plot = MCC_HD, dpi = 1200)
...
PE_HD
ggsave("PE-HD-Case-2.png", plot = PE_HD, dpi = 1200)
```
...
F1_HD
ggsave("F1-HD-Case-2.png", plot = F1_HD, dpi = 1200)
```
...
SE_HD
ggsave("SE-HD-Case-2.png", plot = SE_HD, dpi = 1200)
```
...
SP_HD
ggsave("SP-HD-Case-2.png", plot = SP_HD, dpi = 1200)
```