...
N <- 50
for (snr in 2:8) {
  combss_path = paste0("ThesisResults/COMBSS-Original/COMBSSV0-case-1-n-100-p-1000-q-20-corr-0.8-ninit-1-snr-", snr, "-ndatasets-50-nlam-25-eta-0.001.csv")
  combss_data <- read.csv(combss_path)
...
MCC_HD
ggsave("CH4-MCC-HD-Case-1.png", plot = MCC_HD, dpi = 1200)
...
PE_HD
ggsave("CH4-PE_HD-Case-1.png", plot = PE_HD, dpi = 1200)
```
...
F1_HD
ggsave("CH4-F1_HD-Case-1.png", plot = F1_HD, dpi = 1200)
```
...
SE_HD
ggsave("CH4-SE_HD-Case-1.png", plot = SE_HD, dpi = 1200)
```
...
SP_HD
ggsave("CH4-SP_HD-Case-1.png", plot = SP_HD, dpi = 1200)
```
...
TIME_HD
ggsave("CH4-TIME_HD-Case-1.png", plot = TIME_HD, dpi = 1200)
```